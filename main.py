...
print('-------------------------------')
participants = input("What are the names of the participants (other than you) in the meeting?\n")
...
if result:
    ...
    print("❌ No output generated. Please check if agents or tools failed.")
